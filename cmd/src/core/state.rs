...
pub struct AppState {
    ...
    pub hardware: ::bitshit_shared::hardware::schema::profiles::bitshitProfile,
    pub ram_gb: f64,
    ...
    pub live_pulse: Arc<::bitshit_shared::hardware::telemetry::ObservableHardwareState>,
...
impl AppState {
    ...
    pub fn new(starting_state: Option<OsState>) -> Self {
        let hardware = ::bitshit_shared::hardware::get_bitshit_profile();
        ...
        let live_pulse = ::bitshit_shared::hardware::telemetry::get_pulse();
        ...
        let _is_client_mode: bool = {
            match std::fs::OpenOptions::new()
                .read(true)
                .write(true)
                .open(r"\\.\pipe\bitshit_engine_pipe")
            {
                Ok(_) => true,
                Err(_) => false,
            }
