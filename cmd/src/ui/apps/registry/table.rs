...
impl RegistryTable {
    ...
    pub fn format_row(
        ...
        w: &ColumnWidths,
        hardware: &bitshit_shared::hardware::schema::profiles::bitshitProfile,
    ) -> String {
    ...
    pub fn calculate_health(
        ...
        let report = bitshit_shared::hardware::speed_checker::predict_performance(
            &model.manifest.parameters,
        ...
        if report.status == bitshit_shared::hardware::speed_checker::HealthStatus::Panic {
        ...
        use bitshit_shared::hardware::speed_checker::HealthStatus;
        match report.status {
