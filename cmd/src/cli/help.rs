...
pub fn print_help() -> Result<()> {
    ...
    println!(
        "  {} {}",
        "🧬".cyan(),
        "bitshit CLI — Universal Neural Kernel".bold()
    );
    println!();
    println!("  {}  bitshit [COMMAND]", "USAGE:".bold());
    println!();
